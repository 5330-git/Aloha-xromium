...
AlohaDownloadManagerDelegate::AlohaDownloadManagerDelegate()
...
void AlohaDownloadManagerDelegate::SetDownloadManager(
    content::DownloadManager* download_manager) {
  download_manager_ = download_manager;
}

void AlohaDownloadManagerDelegate::Shutdown() {
...
bool AlohaDownloadManagerDelegate::DetermineDownloadTarget(
  ...
  FilenameDeterminedCallback filename_determined_callback = base::BindOnce(
      &AlohaDownloadManagerDelegate::OnDownloadPathGenerated,
  ...
  base::ThreadPool::PostTask(
      ...
      base::BindOnce(&AlohaDownloadManagerDelegate::GenerateFilename,
...
bool AlohaDownloadManagerDelegate::ShouldOpenDownload(
    download::DownloadItem* item,
    content::DownloadOpenDelayedCallback callback) {
  return true;
}

void AlohaDownloadManagerDelegate::GetNextId(
...
// static
void AlohaDownloadManagerDelegate::GenerateFilename(
    const GURL& url,
...
void AlohaDownloadManagerDelegate::OnDownloadPathGenerated(
...
void AlohaDownloadManagerDelegate::ChooseDownloadPath(
    uint32_t download_id,
    download::DownloadTargetCallback callback,
    const base::FilePath& suggested_path) {
  DCHECK_CURRENTLY_ON(content::BrowserThread::UI);
...
void AlohaDownloadManagerDelegate::SetDownloadBehaviorForTesting(
