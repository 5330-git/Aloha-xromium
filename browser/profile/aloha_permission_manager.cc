...
AlohaPermissionManager::AlohaPermissionManager() = default;

AlohaPermissionManager::~AlohaPermissionManager() {}

void AlohaPermissionManager::RequestPermissions(
...
void AlohaPermissionManager::ResetPermission(PermissionType permission,
                                             const GURL& requesting_origin,
                                             const GURL& embedding_origin) {}

void AlohaPermissionManager::RequestPermissionsFromCurrentDocument(
    content::RenderFrameHost* render_frame_host,
    const content::PermissionRequestDescription& request_description,
    base::OnceCallback<void(const std::vector<blink::mojom::PermissionStatus>&)>
        callback) {
...
blink::mojom::PermissionStatus AlohaPermissionManager::GetPermissionStatus(
...
AlohaPermissionManager::GetPermissionResultForOriginWithoutContext(
...
AlohaPermissionManager::GetPermissionStatusForCurrentDocument(
    PermissionType permission,
    content::RenderFrameHost* render_frame_host,
...
blink::mojom::PermissionStatus
AlohaPermissionManager::GetPermissionStatusForWorker(
    PermissionType permission,
...
blink::mojom::PermissionStatus
AlohaPermissionManager::GetPermissionStatusForEmbeddedRequester(
    blink::PermissionType permission,
    content::RenderFrameHost* render_frame_host,
